...
output "vpc_id" {
  description = "ID da VPC de homologacao."
  value       = module.network.vpc_id
}

output "public_subnet_ids" {
  description = "IDs das subnets publicas de homologacao."
  value       = module.network.public_subnet_ids
}

output "private_subnet_ids" {
  description = "IDs das subnets privadas de homologacao."
...
output "api_gateway_id" {
  description = "ID do API Gateway HTTP de homologacao."
  value       = module.api_gateway_http.api_id
}

output "api_gateway_endpoint" {
  description = "Endpoint padrao execute-api de homologacao."
